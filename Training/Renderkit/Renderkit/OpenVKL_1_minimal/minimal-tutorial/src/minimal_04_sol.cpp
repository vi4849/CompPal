...
int main(int argc, char **argv)
{
  ...
  VKLVolume volume = vklNewVolume(device, "structuredSpherical");             // TO MODIFY
  ...
  vklSetVec3f(volume, "gridSpacing", spacing, 180.f*spacing, 360.f*spacing);   // TO MODIFY
